...
/* ============================================================
   KOMPONEN BANTUAN: KEYBOARD SELALU DI DEPAN MATA
   ============================================================ */
...
/* ============================================================
   KOMPONEN: INFO TERMINAL (Pengganti NPC)
   ============================================================ */
...
/* ============================================================
   KOMPONEN: PC SATUAN & BARIS MEJA (4x2 = 8 PC Per Meja)
   ============================================================ */
            ...
            <a-box position="0 1.05 -0.1" width="0.7" height="0.45" depth="0.05" color="#1a1e24">
                ...
                {isInteractable && isUnlocked && (
                    <a-plane position="0 0 0.027" width="0.66" height="0.41" color="#0f172a" material="opacity: 0.95">
                        <a-text value="KODE BRANKAS:\n4321" align="center" color="#10b981" scale="0.28 0.28 0.28"></a-text>
                    </a-plane>
                )}
...
export default function Room1() {
    ...
    return (
        <a-entity id="raksha-beginner-cross">
            ...
            <ComputerRow x={-2.5} z={-15} rot={90} lockedIndex={1} isPcUnlocked={pcUnlocked} onInteractPc={() => openKeyboardInFront('beginner-pc')} />
            ...
            <a-entity position="-6.80 1 9.40" rotation="0 90 0">
            ...
            {/* === 3. HOLOGRAM BERHASIL (KEMBALI KE LOBBY) === */}
