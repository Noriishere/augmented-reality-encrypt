export default function HUD({ currentRoom, isKeyboardOpen, onToggleKeyboard }) {
  return (
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-between p-4 md:p-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="bg-slate-900/80 border border-cyan-800 px-4 py-2 rounded text-right hidden sm:block">
